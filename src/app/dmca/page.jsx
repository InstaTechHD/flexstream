...
const page = () => {
  return (
    <div className='w-11/12 mt-20 mx-auto text-white min-h-screen'>
        ...
        <p className='mt-4 text-lg'>flexstream.us is a music search engine using open source APIs and does not upload or host any files on it's server. If you are a valid owner of any content listed here & want to remove it then please send us an DMCA formatted takedown notice at <a href='mailto:dmca@flexstream.us' className=' text-cyan-400'>email</a>. We will remove your content as soon as possible.</p>
        ...
        <h2 className='mt-4 text-xl font-bold'>Flexstream.us does not store any files on our server, we only linked to the media which is hosted on 3rd party services.</h2>
    </div>
  )
}
